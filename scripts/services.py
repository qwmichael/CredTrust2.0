...
# def generateSupportingCredential(credential, access_policy, ch_pk, ch_sk, authority_abe_pk, issuing_account, official_issuer):
#     body = {
#         "cham_pk" : ch_pk, 
#         "cham_sk" : ch_sk,
#         "message" : credential,
...
#     cred_id = issueCredential(issuing_account, official_issuer, hash["h"], hash["r"], hash["e"], hash["N1"])
...
# def adaptSupportingCredential(credential_hash, original_msg, new_msg, cham_pk, gid, abe_secret_key, issuer, official_issuer):
...
#     cred_id = issueSupportingCredential(issuer, official_issuer, hash_modified["h"], hash_modified["r"], hash_modified["e"], hash_modified["N1"])
